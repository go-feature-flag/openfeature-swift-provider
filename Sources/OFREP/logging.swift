...
/// Logger used outside of a flag evaluation, where the SDK gives us none: the polling loop and
...
var providerLogger: Logger {
    return OpenFeatureAPI.shared.getLogger() ?? Logger(label: "dev.openfeature.ofrep")
}
